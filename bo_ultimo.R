...
kdataset       <- "./exp/FE8150_7/dataset_7130_ajustado_lags.csv.gz"         # El dataset generado con Feature Engineering
ksemilla_azar  <- 199811  #Aqui poner la propia semilla
kexperimento   <- "HT6330_7"
