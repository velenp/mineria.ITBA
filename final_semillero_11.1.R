...
kdataset       <- "./exp/FE8150_7/dataset_7130_ajustado_lags.csv.gz" 
ksemilla_azar  <- 199813  #Aqui poner la propia semilla
ktraining      <- c( 202101 ,202012,202011)   #periodos en donde entreno
kfuture        <- c( 202103 )   #periodo donde aplico el modelo final


kexperimento   <- "KA8440__11.1"

ksemilla_primos  <-  102191
ksemillerio  <- 100

kmax_bin           <-    31
klearning_rate     <-     0.0495533378576747
knum_iterations    <-   485
knum_leaves        <-   164
kmin_data_in_leaf  <-  540
kfeature_fraction  <-     0.213317216624091
